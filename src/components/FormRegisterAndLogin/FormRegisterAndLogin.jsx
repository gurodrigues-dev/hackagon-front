...
function FormRegisterAndLogin({ registerForm }) {
  ...
  return (
    <form onSubmit={registerForm ? handleRegister : handleLogin} className="form" noValidate>
      <div>
        <input
          className={!inputErrors.nickname ? "form__input inputs" : "form__input form__input--error"}
          type="text"
          name="nickname"
      ...
      </div>
      {
        ...
        <div>
          <input
            className={!inputErrors.email ? "form__input inputs" : "form__input form__input--error"}
            type="email"
            name="email"
            placeholder="E-mail"
            required
      ...
      <div>
        <input
          className={!inputErrors.password ? "form__input inputs" : "form__input form__input--error"}
          type="password"
          name="password"
          placeholder="Senha"
          required
